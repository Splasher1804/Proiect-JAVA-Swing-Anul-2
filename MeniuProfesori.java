...
public class MeniuProfesori extends Main implements ActionListener {
    ...
    MeniuProfesori(){
        ...
        button2.setText("Vizualizare Profesori");
        ...
        frame.setTitle("Meniu Profesori");
    ...
    public void actionPerformed(ActionEvent e){
        ...
        if(e.getSource()==button2){
            frame.dispose();
            VizualizareProfesori meniuP = new VizualizareProfesori();
        }
    }
